...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'codewithme'
    assert response.json()['email'] == 'codewithme@gmail.com'
    assert response.json()['first_name'] == 'Thong2'
    assert response.json()['last_name'] == 'Nguyen2'
